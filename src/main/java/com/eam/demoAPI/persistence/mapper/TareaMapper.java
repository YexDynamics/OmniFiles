...
public interface TareaMapper {
    ...
    @Mapping(target = "etapaFlujoId",      source = "etapaFlujo.id")  // NUEVO
    ...
    @Mapping(target = "etapaFlujo",      source = "etapaFlujoId",      qualifiedByName = "idToEtapaFlujo") // NUEVO
    ...
    // NUEVO
    @Named("idToEtapaFlujo")
    default EtapaFlujo idToEtapaFlujo(Long id) {
        if (id == null) return null;
        EtapaFlujo e = new EtapaFlujo();
        e.setId(id);
        return e;
    }
}
